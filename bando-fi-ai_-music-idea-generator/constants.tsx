...
export const Music2Icon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
...
export const PRESET_VOICES = [
    { id: 'cosmic-diva', name: 'Cosmic Diva' },
    { id: 'cyberpunk-rapper', name: 'Cyberpunk Rapper' },
    { id: 'ethereal-choir', name: 'Ethereal Choir' },
    { id: 'glitch-demon', name: 'Glitch Demon' },
];

export const VOICE_CLONE_MODELS = [
    { id: 'rvc-v2', name: 'RVC v2 (Advanced)' },
    { id: 'xtts-2', name: 'XTTS-2 (Fast)' },
    { id: 'tortoise-v3', name: 'Tortoise v3 (High-Quality)' },
    { id: 'openvoice', name: 'OpenVoice (Cross-Lingual)' },
];